            ...
            <FormGroup>
              ...
              {formik.values.targets && formik.values.targets.length > 0 ? (
                ...
                <Button type="button" onClick={() => arrayHelpers.push("")}>
                  ...
                  Add Papyrus Target ID
                </Button>
              )}
                <FormText color="muted">
                    Papyrus IDs of the targets for which compounds and activity data should be fetched.
                </FormText>
            </FormGroup>
...
class PapyrusCardNew extends React.Component {
  ...
  render() {
    ...
    return (
      <GenericNewMolSetCard
        {...this.props}
        cardHeader="Import compounds from Papyrus++ dataset"
